"""SIDE v2026.09.08.2: actual click handlers + viewport/hit-test regressions.
...
with sync_playwright() as p:
    ...
    browser.close()
(OUT/'ui-final-results.json').write_text(json.dumps({'build':'2026.09.08.2','passed':len(checks),'checks':checks,'page_errors':errors,'scope':'Offline Chromium DOM using delivered HTML/CSS/JS and a Web Storage double. External network, HTTP deployment, Supabase and 3D not tested.'},indent=2))
